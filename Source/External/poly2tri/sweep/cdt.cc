...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fsweep%2Fcdt.cc&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fsweep%2Fcdt.cc" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/poly2tri/source/browse/poly2tri/">poly2tri</a><span class="sp">/&nbsp;</span><a href="/p/poly2tri/source/browse/poly2tri/sweep/">sweep</a><span class="sp">/&nbsp;</span>cdt.cc</span>
 ...
 <li><a href="/p/poly2tri/source/browse/poly2tri/sweep/cdt.cc?r=2c0ebb516e7336ae8ee212b239b068d5e0542f6e" title="Previous">&lsaquo;2c0ebb516e73</a></li>
...
><td class="source">#include &quot;cdt.h&quot;<br></td></tr
><tr
...
><td class="source">CDT::CDT(std::vector&lt;Point*&gt; polyline)<br></td></tr
><tr
...
><td class="source">  sweep_context_ = new SweepContext(polyline);<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_38

><td class="source">  sweep_ = new Sweep;<br></td></tr
><tr
...
><td class="source">void CDT::AddHole(std::vector&lt;Point*&gt; polyline)<br></td></tr
><tr
...
><td class="source">  sweep_context_-&gt;AddHole(polyline);<br></td></tr
><tr
...
><td class="source">void CDT::AddPoint(Point* point) {<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_47

><td class="source">  sweep_context_-&gt;AddPoint(point);<br></td></tr
><tr
...
><td class="source">void CDT::Triangulate()<br></td></tr
><tr
...
><td class="source">  sweep_-&gt;Triangulate(*sweep_context_);<br></td></tr
><tr
...
><td class="source">std::vector&lt;p2t::Triangle*&gt; CDT::GetTriangles()<br></td></tr
><tr
...
><td class="source">  return sweep_context_-&gt;GetTriangles();<br></td></tr
><tr
...
><td class="source">std::list&lt;p2t::Triangle*&gt; CDT::GetMap()<br></td></tr
><tr
...
><td class="source">  return sweep_context_-&gt;GetMap();<br></td></tr
><tr
...
><td class="source">CDT::~CDT()<br></td></tr
><tr
...
><td class="source">  delete sweep_context_;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_68

><td class="source">  delete sweep_;<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/poly2tri/source/detail?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&amp;r=9130cf422d85016277acc4d9836a0181d4b93a7c">9130cf422d85</a>
 by zzzzrrr &lt;mason.green&gt;
 on Feb 7, 2010
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=9130cf422d85016277acc4d9836a0181d4b93a7c&amp;format=side&amp;path=/poly2tri/sweep/cdt.cc&amp;old_path=/poly2tri/sweep/cdt.cc&amp;old=2c0ebb516e7336ae8ee212b239b068d5e0542f6e">Diff</a>
 </div>
 <pre>added AddHole to api; added random
distribution example</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/poly2tri/source/detail?r=9130cf422d85016277acc4d9836a0181d4b93a7c&spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7';
 var publish_url = '/p/poly2tri/source/detail?r=9130cf422d85016277acc4d9836a0181d4b93a7c&spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/README');
 changed_urls.push('/p/poly2tri/source/browse/README?r\x3d9130cf422d85016277acc4d9836a0181d4b93a7c\x26spec\x3dsvnacf81f1f17647fe9574e3ae8f7a1731ee11085c7');
 
 
 changed_paths.push('/poly2tri/sweep/cdt.cc');
 changed_urls.push('/p/poly2tri/source/browse/poly2tri/sweep/cdt.cc?r\x3d9130cf422d85016277acc4d9836a0181d4b93a7c\x26spec\x3dsvnacf81f1f17647fe9574e3ae8f7a1731ee11085c7');
 
 var selected_path = '/poly2tri/sweep/cdt.cc';
 
 
 changed_paths.push('/poly2tri/sweep/cdt.h');
 changed_urls.push('/p/poly2tri/source/browse/poly2tri/sweep/cdt.h?r\x3d9130cf422d85016277acc4d9836a0181d4b93a7c\x26spec\x3dsvnacf81f1f17647fe9574e3ae8f7a1731ee11085c7');
 
 
 changed_paths.push('/poly2tri/sweep/sweep_context.cc');
 changed_urls.push('/p/poly2tri/source/browse/poly2tri/sweep/sweep_context.cc?r\x3d9130cf422d85016277acc4d9836a0181d4b93a7c\x26spec\x3dsvnacf81f1f17647fe9574e3ae8f7a1731ee11085c7');
 
 
 changed_paths.push('/poly2tri/sweep/sweep_context.h');
 changed_urls.push('/p/poly2tri/source/browse/poly2tri/sweep/sweep_context.h?r\x3d9130cf422d85016277acc4d9836a0181d4b93a7c\x26spec\x3dsvnacf81f1f17647fe9574e3ae8f7a1731ee11085c7');
 
 
 changed_paths.push('/testbed/main.cc');
 changed_urls.push('/p/poly2tri/source/browse/testbed/main.cc?r\x3d9130cf422d85016277acc4d9836a0181d4b93a7c\x26spec\x3dsvnacf81f1f17647fe9574e3ae8f7a1731ee11085c7');
 ...
 <option value="/p/poly2tri/source/browse/README?r=9130cf422d85016277acc4d9836a0181d4b93a7c&amp;spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7"
 
 >/README</option>
 
 <option value="/p/poly2tri/source/browse/poly2tri/sweep/cdt.cc?r=9130cf422d85016277acc4d9836a0181d4b93a7c&amp;spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7"
 selected="selected"
 >/poly2tri/sweep/cdt.cc</option>
 
 <option value="/p/poly2tri/source/browse/poly2tri/sweep/cdt.h?r=9130cf422d85016277acc4d9836a0181d4b93a7c&amp;spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7"
 
 >/poly2tri/sweep/cdt.h</option>
 
 <option value="/p/poly2tri/source/browse/poly2tri/sweep/sweep_context.cc?r=9130cf422d85016277acc4d9836a0181d4b93a7c&amp;spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7"
 
 >/poly2tri/sweep/sweep_context.cc</option>
 
 <option value="/p/poly2tri/source/browse/poly2tri/sweep/sweep_context.h?r=9130cf422d85016277acc4d9836a0181d4b93a7c&amp;spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7"
 
 >/poly2tri/sweep/sweep_context.h</option>
 
 <option value="/p/poly2tri/source/browse/testbed/main.cc?r=9130cf422d85016277acc4d9836a0181d4b93a7c&amp;spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7"
 
 >/testbed/main.cc</option>
 ...
 Project members,
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fsweep%2Fcdt.cc&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fsweep%2Fcdt.cc"
 ...
 <a href="/p/poly2tri/source/detail?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=2c0ebb516e7336ae8ee212b239b068d5e0542f6e">2c0ebb516e73</a>
 by zzzzrrr &lt;mason.green&gt;
 on Jan 22, 2010
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=2c0ebb516e7336ae8ee212b239b068d5e0542f6e&amp;format=side&amp;path=/poly2tri/sweep/cdt.cc&amp;old_path=/poly2tri/sweep/cdt.cc&amp;old=4c1c134a6366c112fca302ecdf89d7aa5fdda759">Diff</a>
 <br>
 <pre class="ifOpened">add holes to API</pre>
 </div>
 ...
 by zzzzrrr &lt;mason.green&gt;
 on Jan 22, 2010
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=4c1c134a6366c112fca302ecdf89d7aa5fdda759&amp;format=side&amp;path=/poly2tri/sweep/cdt.cc&amp;old_path=/poly2tri/sweep/cdt.cc&amp;old=663954f7b0903a7f7bfab71a68b5b926eea2f8e9">Diff</a>
 <br>
 ...
 by zzzzrrr &lt;mason.green&gt;
 on Jan 22, 2010
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=663954f7b0903a7f7bfab71a68b5b926eea2f8e9&amp;format=side&amp;path=/poly2tri/sweep/cdt.cc&amp;old_path=/poly2tri/sweep/cdt.cc&amp;old=79a495cb4ebf9fa0ed279710655aa920754f57d4">Diff</a>
 <br>
 <pre class="ifOpened">changed license headers</pre>
 </div>
 
 
 <a href="/p/poly2tri/source/list?path=/poly2tri/sweep/cdt.cc&r=9130cf422d85016277acc4d9836a0181d4b93a7c">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//poly2tri.googlecode.com/hg/poly2tri/sweep/cdt.cc">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7': '/poly2tri/sweep/cdt.cc'}
