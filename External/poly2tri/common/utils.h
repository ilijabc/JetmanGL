...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fcommon%2Futils.h&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fcommon%2Futils.h" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/poly2tri/source/browse/poly2tri/">poly2tri</a><span class="sp">/&nbsp;</span><a href="/p/poly2tri/source/browse/poly2tri/common/">common</a><span class="sp">/&nbsp;</span>utils.h</span>
 ...
 <li><a href="/p/poly2tri/source/browse/poly2tri/common/utils.h?r=44e02186c18558b0fc3c215f649e6a3a55cd9389" title="Previous">&lsaquo;44e02186c185</a></li>
...
><td class="source">#ifndef UTILS_H<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_33

><td class="source">#define UTILS_H<br></td></tr
><tr
...
><td class="source">// Otherwise #defines like M_PI are undeclared under Visual Studio<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_36

><td class="source">#define _USE_MATH_DEFINES<br></td></tr
><tr
...
><td class="source">const double PI_3div4 = 3 * M_PI / 4;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_44

><td class="source">const double PI_div2 = 1.57079632679489661923;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_45

><td class="source">const double EPSILON = 1e-12;<br></td></tr
><tr
...
><td class="source">enum Orientation { CW, CCW, COLLINEAR };<br></td></tr
><tr
...
><td class="source"> * Forumla to calculate signed area&lt;br&gt;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_51

><td class="source"> * Positive if CCW&lt;br&gt;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_52

><td class="source"> * Negative if CW&lt;br&gt;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_53

><td class="source"> * 0 if collinear&lt;br&gt;<br></td></tr
><tr
...
><td class="source"> * A[P1,P2,P3]  =  (x1*y2 - y1*x2) + (x2*y3 - y2*x3) + (x3*y1 - y3*x1)<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_56

><td class="source"> *              =  (x1-x3)*(y2-y3) - (y1-y3)*(x2-x3)<br></td></tr
><tr
...
><td class="source">Orientation Orient2d(Point&amp; pa, Point&amp; pb, Point&amp; pc)<br></td></tr
><tr
...
><td class="source">  double detleft = (pa.x - pc.x) * (pb.y - pc.y);<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_62

><td class="source">  double detright = (pa.y - pc.y) * (pb.x - pc.x);<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_63

><td class="source">  double val = detleft - detright;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_64

><td class="source">  if (val &gt; -EPSILON &amp;&amp; val &lt; EPSILON) {<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_65

><td class="source">    return COLLINEAR;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_66

><td class="source">  } else if (val &gt; 0) {<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_67

><td class="source">    return CCW;<br></td></tr
><tr
...
><td class="source">  return CW;<br></td></tr
><tr
...
><td class="source">bool InScanArea(Point&amp; pa, Point&amp; pb, Point&amp; pc, Point&amp; pd)<br></td></tr
><tr
...
><td class="source">  if (oabd &lt;= EPSILON) {<br></td></tr
><tr
...
><td class="source">  double cdx = pc.x - pdx;<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_91

><td class="source">  double cdy = pc.y - pdy;<br></td></tr
><tr
...
><td class="source">  if (ocad &lt;= EPSILON) {<br></td></tr
><tr
...
><td class="source">  double oadb = (pa.x - pb.x)*(pd.y - pb.y) - (pd.x - pb.x)*(pa.y - pb.y);<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_109

><td class="source">  if (oadb &gt;= -EPSILON) {<br></td></tr
><tr
...
><td class="source">  double oadc = (pa.x - pc.x)*(pd.y - pc.y) - (pd.x - pc.x)*(pa.y - pc.y);<br></td></tr
><tr
id=sl_svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7_114

><td class="source">  if (oadc &lt;= EPSILON) {<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 on Apr 7, 2012
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=acf81f1f17647fe9574e3ae8f7a1731ee11085c7&amp;format=side&amp;path=/poly2tri/common/utils.h&amp;old_path=/poly2tri/common/utils.h&amp;old=44e02186c18558b0fc3c215f649e6a3a55cd9389">Diff</a>
 </div>
...
hole</pre>
 ...
 var selected_path = '/poly2tri/common/utils.h';
 ...
 Project members,
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fcommon%2Futils.h&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fpoly2tri%2Fsource%2Fbrowse%2Fpoly2tri%2Fcommon%2Futils.h"
 ...
 <a href="/p/poly2tri/source/detail?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=44e02186c18558b0fc3c215f649e6a3a55cd9389">44e02186c185</a>
 by Mason Green &lt;mason.green&gt;
 on Feb 4, 2012
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=44e02186c18558b0fc3c215f649e6a3a55cd9389&amp;format=side&amp;path=/poly2tri/common/utils.h&amp;old_path=/poly2tri/common/utils.h&amp;old=4f9c0ace716b2d1dbb9f43e00d7f6934bb7763ea">Diff</a>
 <br>
 <pre class="ifOpened">InScanArea fixed again</pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/poly2tri/source/detail?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=4f9c0ace716b2d1dbb9f43e00d7f6934bb7763ea">4f9c0ace716b</a>
 by Mason Green &lt;mason.green&gt;
 on Feb 4, 2012
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=4f9c0ace716b2d1dbb9f43e00d7f6934bb7763ea&amp;format=side&amp;path=/poly2tri/common/utils.h&amp;old_path=/poly2tri/common/utils.h&amp;old=70e5067a1b7ce4ba988b1b788dad594dd0d8527d">Diff</a>
 <br>
 <pre class="ifOpened">updated InScanArea</pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/poly2tri/source/detail?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=70e5067a1b7ce4ba988b1b788dad594dd0d8527d">70e5067a1b7c</a>
 by Mason Green &lt;mason.green&gt;
 on Jul 2, 2011
 &nbsp; <a href="/p/poly2tri/source/diff?spec=svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7&r=70e5067a1b7ce4ba988b1b788dad594dd0d8527d&amp;format=side&amp;path=/poly2tri/common/utils.h&amp;old_path=/poly2tri/common/utils.h&amp;old=cc86a7f3e81cf6aa703ee3199c4a7ee052c9992c">Diff</a>
 <br>
 <pre class="ifOpened">added #define for MSVC</pre>
 </div>
 
 
 <a href="/p/poly2tri/source/list?path=/poly2tri/common/utils.h&r=acf81f1f17647fe9574e3ae8f7a1731ee11085c7">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//poly2tri.googlecode.com/hg/poly2tri/common/utils.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svnacf81f1f17647fe9574e3ae8f7a1731ee11085c7': '/poly2tri/common/utils.h'}
